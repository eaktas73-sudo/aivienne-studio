    ...
    const emailHtml = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #111; max-width: 600px; padding: 24px; border: 1px solid #e5e5e5; border-radius: 16px; background: #ffffff;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 20px;">
          <tr>
            <td style="padding: 8px 0; color: #666; width: 140px;"><strong>Yetkili / Marka:</strong></td>
            <td style="padding: 8px 0; color: #111;">${name}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666;"><strong>Kurumsal E-Posta:</strong></td>
            <td style="padding: 8px 0;"><a href="mailto:${email}" style="color: #d97706; text-decoration: none;">${email}</a></td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666;"><strong>Web Sitesi:</strong></td>
            <td style="padding: 8px 0; color: #111;">${website || "Belirtilmedi"}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666;"><strong>Lansman / Teslim:</strong></td>
            <td style="padding: 8px 0; color: #111;">${launchDate || "Esnek"}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666;"><strong>Prodüksiyon Alanı:</strong></td>
            <td style="padding: 8px 0; color: #111;">${service}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666;"><strong>Bütçe Aralığı:</strong></td>
            <td style="padding: 8px 0; color: #111;">${budget}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #666;"><strong>Karşılıklı NDA:</strong></td>
            <td style="padding: 8px 0; color: #111;">${requireNDA ? "EVET (Talep Edildi)" : "HAYIR"}</td>
          </tr>
        </table>
